...
function uswds_form_system_theme_settings_alter(&$form, $form_state) {
  ...
  $form['menu_fieldset'] = array(
    ...
    'uswds_menu_accordion_duplicate_parent' => array(
      '#type' => 'checkbox',
    ...
    'uswds_menu_bypass' => array(
      '#type' => 'checkboxes',
      '#title' => t('Bypass USWDS menu processing for these menus.'),
      '#description' => t('Choose the menus which you would like to exempt from USWDS alterations. Note that a cache clear may be needed after changing these settings.'),
      '#options' => array(
